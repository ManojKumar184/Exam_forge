...
const sidebarItems: SidebarItem[] = [
  ...
  { name: 'Syllabus', path: '/syllabus', icon: <Layers className="w-5 h-5" />, roles: ['super_admin'] },
  { name: 'New Paper', path: '/papers/new', icon: <FileText className="w-5 h-5" />, roles: ['super_admin', 'faculty'] },
  { name: 'My Papers', path: '/papers', icon: <FileText className="w-5 h-5" />, roles: ['super_admin', 'faculty'] },
  { name: 'Templates', path: '/templates', icon: <Layers className="w-5 h-5" />, roles: ['super_admin', 'faculty'] },
