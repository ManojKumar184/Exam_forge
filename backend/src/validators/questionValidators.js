...
export const createQuestionSchema = z.object({
  ...
  extracted_from: z.string().optional().nullable(),
  upload_id: z.string().optional().nullable(),
  created_by: z.string().optional().nullable(),
  debug_info: z.any().optional().nullable(),
  semantic_enriched: z.boolean().optional(),
